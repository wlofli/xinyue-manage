	...
	<div class="c_right">
		...
		<div class="c_r_bt1">
			<ul class="menu1" id="menu">
				<li class="hit"><a>新越网平台问答</a></li>
				<li class="" onclick="document.location.href='${ctx}/credit/manager/detail/jans?index=1'"><a>所在机构问答</a></li>
			</ul>
		</div>
		<div class="c_table" id="tab0">
			<div class="c_table">
				<table class="table" cellpadding="0" cellspacing="0">
					...
					<tbody>
						<c:forEach items="${xanswerpage.data }" var="quest">
							<tr>
			...
			<div class="page">
				<m:page url="${ctx }/credit/manager/detail/xans?index=1&topage=" pageData="${xanswerpage }"></m:page>
			</div>
		</div>
	</div>
