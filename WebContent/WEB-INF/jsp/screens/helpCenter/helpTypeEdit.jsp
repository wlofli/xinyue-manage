...
<body>
<div class="c_right">
	<div class="c_r_bt"><h1><img src="${ctx}/images/help_tb1.png" alt="添加帮助分类" id="title_img"/><span id="title">添加帮助分类</span></h1></div>
	<div class="c_form">
		<sf:form action="${ctx}/help/type/submit" commandName="helpType" method="post" id="editForm">
			<div>
				<span>分类名称：</span>
			...
			<div>
				<span>分类序号：</span>
				<sf:input path="orderNum" class="t1 required digits" id="id_author"/><div class="clear"></div>
			</div>
			<div>
