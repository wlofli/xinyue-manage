...
<li><span>推荐信贷经理数：</span><sf:input path="recommendCreditNum" cssClass="s1 digits"/></li>
<li><span>推荐信贷经理充值金额：</span><sf:input path="recommendRechargeNum" cssClass="s1 digits"/></li>
<li><span>所在地：</span>
...
<td colspan="1">推荐信贷经理数</td>
<td colspan="2">推荐信贷经理充值金额(元)</td>
...
<td colspan="1">${list.recommendCreditNum }</td> 
