...
<c:when test="${order.status == '新订单' || order.status =='新越网审核中' }">
	<div><span>审核时间：</span><input type="text" class="t1" disabled="disabled" value="<fmt:formatDate value="${order.taxAuditeTime }" type="both" pattern="yyyy-MM-dd h:m"/>" /><div class="clear"></div></div>
